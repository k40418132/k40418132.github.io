function on_Mypage(){
  document.location.href="http://pluto.mfvps.cn/Plutoindex/personalpage?id=" + window.localStorage['id'];
}
function on_Editpage(){
  document.location.href="http://pluto.mfvps.cn/Plutoindex/personalpage/edit.html";
}
